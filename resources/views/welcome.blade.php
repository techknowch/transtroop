      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="slider-content">
            ...
            <a class="st__btn mt-40" href="service-details.html"> More Details <i class="bi bi-arrow-right"></i>
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="st__feature__bottom text-center wow fadeInUp mt-55">
          <span class="text-white">Our list of services does not end here. Find out how we can help you and your business. <a href="#"> More Services </a>
          </span>
        </div>
      </div>
    </div>
          ...
          <div class="st__about__content wow fadeInUp">
            <div class="st__about__iconbox mt-35 d-flex">
              ...
              <div class="st__about__iconcontent">
                <h3>What Is Truck Dispatch Services?</h3>
                <p>Truck dispatch services are designed to streamline the process of finding and booking freight loads, negotiating rates, and handling the administrative tasks that come with running a trucking company.</p>
              </div>
            </div>
            <div class="st__about__btn mt-50">
              <a class="st__btn2" href="service-details.html"> More Details <i class="bi bi-arrow-right"></i>
              </a>
            </div>
            <div class="st__about__infometa">
              <div class="st__iconmeta__inner d-flex">
                <div class="st__about__info__icon">
                  <a href="tel:+562015550124">
                    <i class="bi bi-telephone"></i>
                  </a>
                </div>
                <div class="st__about__infocontent">
                  <span>Contact</span> (872) 266-3183, 315-227-9247
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="st__project__single p-relative">
          <div class="st__project__thumb">
            ...
            <div class="st__project__content">
              <h2>
                <a href="#">Box Truck RC</a>
              </h2>
              <!-- <span>Highest Paying</span> -->
            </div>
            <div class="st__project__btn">
              <a href="#"> Details <i class="bi bi-arrow-right"></i>
              </a>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="st-call-do-action-content text-center wow fadeInUpBig">
          ...
          <a class="st__btn mt-40" href="#"> Read More <i class="bi bi-arrow-right"></i>
          </a>
        </div>
      </div>
    </div>
...
<!-- ST Blog Area -->
<!-- <div class="st-blog-area pb-100"><div class="container"><div class="row"><div class="col-lg-12"><div class="st__section__title mb-50 text-center wow fadeInUp"><h5> Our News from Blog </h5><span class="circle"></span><h1>The latest News & Best Blog</h1></div></div></div><div class="row"><div class="col-lg-4 col-md-6"><div class="st__blog__single__box wow fadeInUp"><div class="st__blog__thumb"><img src="assets/images/blog/b1.jpg" alt=""></div><div class="st__blog__content"><div class="st__meta__top"><div class="st__blog__meta"><div class="st__blog__meta__inner d-flex align-items-center"><div class="st__meta__thumb"><img src="assets/images/blog/meta.png" alt=""></div><div class="st__blog__meta__content"><span><a href="blog-details.html">By Admin</a></span></div></div></div><div class="st__blog__cmt"><i class="bi bi-chat"></i><span>{6}Comments</span></div></div><h2><a href="blog-details.html"> New Additions to our great Metro trucks. </a></h2><a class="st_blog_btn" href="#"> Read More <i class="bi bi-arrow-up-short"></i></a></div></div></div><div class="col-lg-4 col-md-6"><div class="st__blog__single__box wow fadeInUp"><div class="st__blog__content"><div class="st__meta__top"><div class="st__blog__meta"><div class="st__blog__meta__inner d-flex align-items-center"><div class="st__meta__thumb"><img src="assets/images/blog/meta.png" alt=""></div><div class="st__blog__meta__content"><span><a href="blog-details.html">By Admin</a></span></div></div></div><div class="st__blog__cmt"><i class="bi bi-chat"></i><span>{6}Comments</span></div></div><h2><a href="blog-details.html"> New Additions to our great Metro trucks. </a></h2><a class="st_blog_btn" href="#"> Read More <i class="bi bi-arrow-up-short"></i></a></div><div class="st__blog__thumb style2"><img src="assets/images/blog/b2.jpg" alt=""></div></div></div><div class="col-lg-4 col-md-6"><div class="st__blog__single__box wow fadeInUp"><div class="st__blog__thumb"><img src="assets/images/blog/b3.jpg" alt=""></div><div class="st__blog__content"><div class="st__meta__top"><div class="st__blog__meta"><div class="st__blog__meta__inner d-flex align-items-center"><div class="st__meta__thumb"><img src="assets/images/blog/meta.png" alt=""></div><div class="st__blog__meta__content"><span><a href="blog-details.html">By Admin</a></span></div></div></div><div class="st__blog__cmt"><i class="bi bi-chat"></i><span>{6}Comments</span></div></div><h2><a href="blog-details.html"> New Additions to our great Metro trucks. </a></h2><a class="st_blog_btn" href="#"> Read More <i class="bi bi-arrow-up-short"></i></a></div></div></div></div></div></div> -->
<!-- ST Brand Area -->
<!-- <div class="st-brand-area pb-120"><div class="container"><div class="row"><div class="col-lg-12"><div class="brand-title text-center wow fadeInUp"><h2>Our Partners & Suppoters</h2></div></div><div class="brand-carousel owl-carousel wow fadeInUp"><div class="st__brand__thumb"><img src="assets/images/brand/b.png" alt=""></div></div></div></div></div> --> @endsection